...
export namespace Prisma {
  ...
  */
  ...
  export type ScoreGetPayload<
    ...
    : S extends undefined
    ? never
    : S extends ScoreArgs | ScoreFindManyArgs
    ?'include' extends U
    ? Score 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
    P extends keyof Score ? Score[P] : never
  } 
    : Score
  : Score


  type ScoreCountArgs = Merge<
    Omit<ScoreFindManyArgs, 'select' | 'include'> & {
      select?: ScoreCountAggregateInputType | true
    }
  >

  export interface ScoreDelegate<GlobalRejectSettings> {
    /**
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Score'> extends True ? CheckSelect<T, Prisma__ScoreClient<Score>, Prisma__ScoreClient<ScoreGetPayload<T>>> : CheckSelect<T, Prisma__ScoreClient<Score | null >, Prisma__ScoreClient<ScoreGetPayload<T> | null >>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Score'> extends True ? CheckSelect<T, Prisma__ScoreClient<Score>, Prisma__ScoreClient<ScoreGetPayload<T>>> : CheckSelect<T, Prisma__ScoreClient<Score | null >, Prisma__ScoreClient<ScoreGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<Score>>, PrismaPromise<Array<ScoreGetPayload<T>>>>
    ...
    **/
    ...
    /**
     * Find one Score that matches the filter or throw
   ...
   */
  export class Prisma__ScoreClient<T> implements PrismaPromise<T> {
    [prisma]: true;
   ...
   */
  export type ScoreFindUniqueOrThrowArgs = ScoreFindUniqueArgsBase
      

  /**
   * Score: findFirstOrThrow
   */
  export type ScoreFindFirstOrThrowArgs = ScoreFindFirstArgsBase
